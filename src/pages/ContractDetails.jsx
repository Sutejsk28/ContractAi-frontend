...
function ContractDetails() {
  ...
  return (
    <div className="mt-5 p-4">
      ...
      <div className="flex mt-7">
        ...
        <div className="flex">
          ...
          <Button asChild className="ml-3" variant="outline">
            <a href={`${contract?.fileUrl}`}>View PDF</a>
          </Button>
          <Button asChild className="ml-3" variant="outline">
      ...
      <div className="flex mt-16 p-3 gap-2">
        <div className="flex-1">

        <div className="border rounded-lg shadow-xl p-8 ">
          <h1 className="text-2xl font-thin mb-2 text-red-600">Risk Summary</h1>
          <hr className="mb-3" />
        ...
        <div className="flex-1 border rounded-lg shadow-xl p-8 size-1/2">
